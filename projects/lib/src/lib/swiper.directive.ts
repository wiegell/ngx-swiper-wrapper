...
export class SwiperDirective
  implements AfterViewInit, OnDestroy, DoCheck, OnChanges {
  ...
  S_TOUCHMOVEOPPOSITE = new EventEmitter<any>();
  ...
  S_SLIDEPREVTRANSITIONEND = new EventEmitter<any>();
  @Output("slidePrevTransitionStart")
  S_SLIDEPREVTRANSITIONSTART = new EventEmitter<any>();
  @Output("slideNextTransitionEnd")
  S_SLIDENEXTTRANSITIONEND = new EventEmitter<any>();
  @Output("slideNextTransitionStart")
  S_SLIDENEXTTRANSITIONSTART = new EventEmitter<any>();
  @Output("slideChangeTransitionEnd")
  S_SLIDECHANGETRANSITIONEND = new EventEmitter<any>();
  @Output("slideChangeTransitionStart")
  S_SLIDECHANGETRANSITIONSTART = new EventEmitter<any>();
  ...
  ngAfterViewInit(): void {
    ...
    SwiperEventNames.forEach((eventName: SwiperEvent) => {
      ...
      this.instance.on(swiperEvent, (...args: any[]) => {
        ...
        const emitter = this[
          output as keyof SwiperDirective
        ] as EventEmitter<any>;
